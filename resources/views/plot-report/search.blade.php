                            ...
                            <fieldset class="childTab scheduler-border">
                                ...
                                <div class="control-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" >
                                           <a href="/admin/plot-report/tranfer-details" class="plotURL"> <label class="badge badge-primery" id="totalTransfer"></label>View</a>
                                        </div>
                                    </div>
                                   <div class="row">
                                        <div class="col-md-3">
    ...
    function transferHistory(){
             $('#voyager-loader').css('display', 'block');
               ...
               $('#voyager-loader').css('opacity', '0.4');
                var plot = $('#plot').val();
                var url = '/admin/plot-report/transfer-details/'+plot;
                $('.plotURL').attr('href', url);
                $.ajax({
