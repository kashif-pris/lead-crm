    ...
    <div class="col-md-6">
        <label for="customer">Transferer</label>
            <select class="form-control  " id="from_customer" name="customer_from"  tabindex="-1" aria-hidden="true">
                ...
                <option {{$transfer['from_customer'] == $item->id ? "selected" : ""}} value="{{$item->id}}" >{{$item->name}}</option>
                @endforeach
            </select>
            ...
            <div class="col-md-6">
                <label for="customer">Transferee</label>
                    <select class="form-control select2 " id="to_customer" name="customer_to"  tabindex="-1" aria-hidden="true">
                        @foreach($customers as $item)
                        <option {{$transfer['to_customer'] == $item->id ? "selected" : ""}}  value="{{$item->id}}" >{{$item->name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th colspan="2">To Customer Docs</th>
                              </tr>
                          <tr>
                            <th>Title</th>
                            <th>File</th>
