            ...
            <div class="row">
                ...
                ">
                    ...
                    <tr style="height: 50px !important;">
                        <td>Name: {{$merge->customers->name}}</td>
                        <td>Plot 1:{{$merge->plotFirst->name}}</td>
                        <td>Plot 2:{{$merge->plotSecond->name}}</td>
                    </tr>
                  
                    <tr style="height: 50px !important;">
                        <td>CNIC: {{$merge->customers->cnic}}</td>
                        <td>Size:{{$merge->plotFirst->size}} </td>
                        <td>Size:{{$merge->plotSecond->size}} </td>
                    </tr>
                    <tr style="height: 50px !important;">
                        <td>Contact: {{$merge->customers->phone_1}}</td>
                        <td>Category:{{$merge->plotFirst->status}}</td>
                        <td>Category:{{$merge->plotSecond->status}}</td>
                    </tr>
                    </table>
                ...
                <div class="row">
                    ...
                    <b>Name:</b> {{$merge->customers->name}} <b>S/O:</b> {{$merge->customers->son_of}} <b>R/O:</b>___________________________ <b>Allotted House No.</b> in 
                    DEFENCE CITY.<br>
                    <b>Sign of Allottee</b> _______________ <b>CNIC No</b>. {{$merge->customers->cnic}}
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="{{route('merge.reject')}}">
                    @csrf
