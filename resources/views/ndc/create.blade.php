...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            ...
            <a href="/admin/ndc/create" class="btn btn-success btn-add-new">
               <span>NDC Certificates</span>
            </a>
                ...
                <table id="dataTable" class="display" style="width:100%">
                    <thead>
                      ...
                      <tbody>
                        ...
                        @php 
                        $certificate = DB::table('ndc')->where('booking_id',$item->id)->first(); 
                       
                        // dd($certificate);
                        $countCertificate = DB::table('ndc')->where(['booking_id'=>$item->id])->where('type','duplicate')->count(); 
                        ...
                        <tr>
                            ...
                            <td>
                                @if(!empty($certificate))
                                <a href="/admin/ndc/generate/{{$item->id}}">
