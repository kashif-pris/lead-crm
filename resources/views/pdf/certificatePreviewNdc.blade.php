	...
	<div class="col-md-12">
        <div class="panel panel-defualt">
            ...
            <div class="row">
                    <div id="page-wrap">
                        <div class="badge">
                            <h1 style="text-align: center;margin-bottom: 100px;">NDC CERTIFICATE</h1>
                        </div>
                    </div>
                ...
                <div class="row" style=" margin-top: 113px; ">
                    <div class="col-md-4">
                        <h4 style=" border-top: 1px solid; width: 183px; text-align-last: center; position: relative; left: 950; ">Accounts Clearance</h4>
                    </div>
                    <div class="col-md-4">
                        <h4 style=" border-top: 1px solid; width: 183px; text-align-last: center; position: relative; left: 950; ">Utilities Clearance</h4>
                    </div>
                    <div class="col-md-4">
                        <h4 style=" border-top: 1px solid; width: 220px; text-align-last: center; position: relative; left: 950; ">Maintainance Clearance</h4>
                    </div>
                </div>
            </div>
            <br><br><br>
