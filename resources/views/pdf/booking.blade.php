...
<style>
.col-md-1 {width:8%;  float:left;-webkit-box-flex: 0;-ms-flex: 0 0 8%;flex: 0 0 8%;}
.col-md-2 {width:16%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 16%;flex: 0 0 16%;}
.col-md-3 {width:25%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 25%;flex: 0 0 25%;}
.col-md-4 {width:33%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 33%;flex: 0 0 33%;}
.col-md-5 {width:42%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 42%;flex: 0 0 42%;}
.col-md-6 {width:50%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 50%;flex: 0 0 50%;}
.col-md-7 {width:58%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 58%;flex: 0 0 58%;}
.col-md-8 {width:66%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 66%;flex: 0 0 66%;}
.col-md-9 {width:75%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 75%;flex: 0 0 75%;}
.col-md-10{width:83%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 83%;flex: 0 0 83%;}
.col-md-11{width:92%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 92%;flex: 0 0 92%;}
.col-md-12{width:100%; float:left;-webkit-box-flex: 0;-ms-flex: 0 0 100%;flex: 0 0 100%;} 
          ...
          <div class="col-md-12 mt-5">
            <h5>PLOT DETAILS:</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mb-3">
                        <input  maxlength="100" type="text" value="{{$booking['customers']['mail_address']}}"   required="required" class="form-control" placeholder="Enter Applicant Name" style=" height: 33px; position: relative; left: 28px;    border: 2px solid black; "  />
                    </div>
                    ...
                    <div class="col-md-2 mb-3">
                        <input  maxlength="100" type="text" value="{{$booking['customers']['permanent_address']}}"  required="required" class="form-control" placeholder="Enter Applicant Name" style=" height: 33px; position: relative; left: 28px;    border: 2px solid black; "  />
                    </div>
