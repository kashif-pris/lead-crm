            ...
            <div class="row">
                ...
                ">
                    ...
                    <tr style="height: 50px !important;">
                        <td>Name: {{$plot->booking->customers->name}}</td>
                        <td>Plot:{{$plot->booking->plots->name}}</td>
                    </tr>
                    <tr style="height: 50px !important;">
                        <td>Address: {{$plot->booking->customers->address}}</td>
                        <td>Precinct:
                    ...
                    <tr style="height: 50px !important;">
                        <td>CNIC: {{$plot->booking->customers->cnic}}</td>
                        <td>Size:{{$plot->booking->plot_size}} </td>
                    </tr>
                    <tr style="height: 50px !important;">
                        <td>Contact: {{$plot->booking->customers->phone_1}}</td>
                ...
                <div class="row">
                    ...
                    <b>Name:</b> {{$plot->booking->customers->name}} <b>S/O:</b> {{$plot->booking->customers->son_of}} <b>R/O:</b>___________________________ <b>Allotted House No.</b> {{$plot->id}} <b> {{$plot->id}}</b> in 
                    DEFENCE CITY.<br>
                    <b>Sign of Allottee</b> _______________ <b>CNIC No</b>. {{$plot->booking->customers->cnic}}
